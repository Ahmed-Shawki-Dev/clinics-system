...
import {
  getFinanceByDoctorAction,
  getYearlyFinanceAction,
...
export default async function OwnerDashboard({
    ...
    return (
      <DashboardShell>
        <Alert variant="destructive" className="mt-4">
          ...
          <AlertDescription>
            {dailyRes.message ||
              "حدث خطأ أثناء جلب البيانات المالية. يرجى المحاولة لاحقاً."}
          </AlertDescription>
        </Alert>
      </DashboardShell>
    );
  ...
  const { totalRevenue, totalPaid, totalUnpaid, invoiceCount, paymentCount } =
    dailyRes.data;
