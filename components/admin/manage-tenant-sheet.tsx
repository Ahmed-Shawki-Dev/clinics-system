...
export function ManageTenantSheet({
  tenant,
  isOpen,
  onClose,
}: ManageTenantSheetProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="overflow-y-auto sm:max-w-125" dir="rtl">
        ...
        <Tabs defaultValue="flags" className="mt-6">
          ...
          <TabsContent value="flags" className="flex min-h-75 flex-col">
            {isLoading ? (
