...
export function AppHeader() {
  ...
  return (
    <header className="bg-background sticky top-0 z-40 flex h-16 w-full shrink-0 items-center gap-2 border-b px-4">
      ...
      <div className="flex flex-1 items-center gap-2 text-sm">
        ...
        <h2 className="text-foreground font-semibold">{getTitle()}</h2>
      </div>

      <div className="flex items-center gap-4">
        {isNotDoctor && user?.tenantSlug && (
          <DoctorNotesBell tenantSlug={user.tenantSlug} />
        )}
