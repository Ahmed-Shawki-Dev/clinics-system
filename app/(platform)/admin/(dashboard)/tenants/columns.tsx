...
export const columns: ColumnDef<ITenant>[] = [
  ...
  },
  {
    ...
    header: "المعرف (Slug)",
    cell: ({ row }) => (
      <span className="text-muted-foreground bg-muted/20 inline-block rounded px-2 py-1 font-mono text-sm">
        {row.getValue("slug")}
      </span>
    ),
  },
  {
    ...
    header: "رقم التواصل",
    cell: ({ row }) => (
      <div dir="ltr" className="text-muted-foreground text-right">
