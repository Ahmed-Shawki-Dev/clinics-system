      ...
      <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          {tenant.status !== "Active" && (
            <DropdownMenuItem
              onClick={() =>
                handleAction(activateTenantAction, "تم تفعيل العيادة بنجاح")
              }
          ...
          {tenant.status === "Active" && (
            <DropdownMenuItem
              onClick={() =>
                handleAction(suspendTenantAction, "تم إيقاف العيادة مؤقتاً")
              }
              className="cursor-pointer text-yellow-600 focus:bg-yellow-50 focus:text-yellow-600"
            >
          ...
          {tenant.status !== "Blocked" && (
            <DropdownMenuItem
              onClick={() =>
                handleAction(blockTenantAction, "تم حظر العيادة نهائياً")
              }
