...
export function AppointmentsView({
  ...
  const getOperationalBadge = (purpose: string) => {
    ...
    return (
      <Badge
        variant="secondary"
        className={cn("h-4 rounded-sm px-1.5 text-[9px] whitespace-nowrap")}
      >
                    ...
                    <TableCell>
                      <div className="flex flex-col gap-1 text-right">
                        <div className="flex items-center gap-2 text-sm font-medium">
                          <Stethoscope className="text-primary h-3.5 w-3.5 shrink-0" />
                          {booking.doctorName}
                        </div>
                        <div className="text-muted-foreground mr-5 flex items-center gap-2 text-[11px]">
                          {booking.serviceName && (
