...
export default async function PatientsPage({
  ...
  return (
    <DashboardShell>
      <DashboardHeader
        heading="سجل المرضى"
        text="إدارة بيانات المرضى والبحث المتقدم داخل العيادة"
      >
        <PermissionGate
          allowedRoles={[
            ROLES.CLINIC_OWNER,
      ...
      <div className="space-y-4">
        ...
        <PermissionGate
          ...
          fallback={
            <div className="bg-muted/20 flex h-100 shrink-0 items-center justify-center rounded-md border border-dashed">
              <Typography variant="muted">
                عذراً، لا تملك صلاحية عرض السجلات.
              </Typography>
            </div>
          }
        >
