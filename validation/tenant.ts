...
export const CreateTenantSchema = v.object({
  ...
  slug: v.pipe(
    ...
    v.regex(
      /^[a-z0-9\-]+$/,
      "يجب أن يكون حروف إنجليزية صغيرة وأرقام وعلامة (-) فقط",
    ),
  ...
  ownerName: v.pipe(
    v.string(),
    v.nonEmpty("اسم المالك مطلوب"),
    v.maxLength(200),
  ),
  ownerUsername: v.pipe(
    v.string(),
    v.nonEmpty("اسم المستخدم مطلوب"),
    v.maxLength(50),
  ),
