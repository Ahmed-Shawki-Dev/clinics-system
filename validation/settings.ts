...
export const UpdateSettingsSchema = v.object({
  ...
  phone: v.optional(
    v.pipe(v.string(), v.maxLength(20, "رقم الهاتف لا يجب أن يتجاوز 20 حرفاً")),
  ),
  whatsAppSenderNumber: v.optional(v.string()),
  supportWhatsAppNumber: v.optional(v.string()),
  supportPhoneNumber: v.optional(v.string()),
  address: v.optional(
    v.pipe(v.string(), v.maxLength(500, "العنوان طويل جداً")),
  ),
  city: v.optional(
    v.pipe(
      v.string(),
      v.maxLength(100, "اسم المدينة لا يجب أن يتجاوز 100 حرف"),
    ),
  ),
  logoUrl: v.optional(v.string()),
  imgUrl: v.optional(v.string()),
  description: v.optional(
    v.pipe(v.string(), v.maxLength(3000, "الوصف طويل جداً")),
  ),
