...
export async function createDoctorNoteAction(
  tenantSlug: string,
  message: string,
) {
...
export async function markDoctorNoteAsReadAction(
  tenantSlug: string,
  noteId: string,
) {
  return await fetchApi<IDoctorNote>(
    `/api/clinic/doctor-notes/${noteId}/read`,
    {
      method: "POST",
      tenantSlug,
      authType: "staff",
