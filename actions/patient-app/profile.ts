...
export async function getPatientProfileAppAction(
  tenantSlug: string,
  patientId: string,
) {
  return await fetchApi<IPatient>(
    `/api/clinic/patient-app/profiles/${patientId}`,
    {
      method: "GET",
      tenantSlug,
...
export async function getPatientSummaryAppAction(
  tenantSlug: string,
  patientId: string,
) {
  return await fetchApi<IPatientSummary>(
    `/api/clinic/patient-app/profiles/${patientId}/summary`,
    {
      method: "GET",
      tenantSlug,
      authType: "patient",
...
export async function getPatientQueueTicketAppAction(
  tenantSlug: string,
  patientId: string,
) {
...
export async function getPatientBookingsAppAction(
  tenantSlug: string,
  patientId: string,
) {
  return await fetchApi<IBooking[]>(
    `/api/clinic/patient-app/profiles/${patientId}/bookings`,
    {
      method: "GET",
      tenantSlug,
      authType: "patient",
...
export async function getPatientCreditBalanceAction(
  ...
  return await fetchApi<ICreditBalance>(
    `/api/clinic/patient-credits/${patientId}/balance`,
    {
      method: "GET",
      tenantSlug,
