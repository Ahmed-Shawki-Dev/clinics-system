...
export async function createTicket(tenantSlug: string, data: CutTicketInput) {
  if (data.doctorServiceId) {
    const res = await fetchApi<IQueueTicket>(
      `/api/clinic/queue/tickets/with-payment`,
      {
        method: "POST",
...
export async function markTicketUrgent(
  ...
  const response = await fetchApi<IQueueTicket>(
    `/api/clinic/queue/tickets/${ticketId}/urgent`,
    {
      method: "POST",
      tenantSlug,
    },
...
export async function cancelTicket(
  ...
  const response = await fetchApi<IQueueTicket>(
    `/api/clinic/queue/tickets/${ticketId}/cancel`,
    {
      method: "POST",
      tenantSlug,
    },
...
export async function callTicketAction(
  ...
  const result = await fetchApi<IQueueTicket>(
    `/api/clinic/queue/tickets/${ticketId}/call`,
    {
      method: "POST",
      tenantSlug,
    },
...
export async function finishTicketAction(
  ...
  const result = await fetchApi<IQueueTicket>(
    `/api/clinic/queue/tickets/${ticketId}/finish`,
    {
      method: "POST",
      tenantSlug,
    },
...
export async function skipTicketAction(
  ...
  const result = await fetchApi<IQueueTicket>(
    `/api/clinic/queue/tickets/${ticketId}/skip`,
    {
      method: "POST",
      tenantSlug,
    },
